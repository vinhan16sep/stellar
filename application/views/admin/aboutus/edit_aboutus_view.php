        ...
        <div class="row modified-mode">
            <div class="col-lg-10 col-lg-offset-0">
                ...
                <div class="form-group picture">
                    ...
                    echo form_input('aboutus_title', set_value('aboutus_title', $aboutus['aboutus_title']), 'class="form-control"');
                    ?>
                </div>
                <div class="form-group">
                    ...
                    echo form_textarea('aboutus_content', set_value('aboutus_content', $aboutus['aboutus_content'], false), 'class="form-control"')
                    ?>
                </div>
                <div class="form-group">
                    ...
                    echo form_dropdown('aboutus_is_select', array('0' => 'No', '1' => 'Yes'), set_value('aboutus_is_select', $aboutus['aboutus_is_select']), 'class="form-control"');
                    ?>
                </div>
                <br>
