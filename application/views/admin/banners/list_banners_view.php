...
<div class="content-wrapper">
    <section class="content">
        ...
        <div class="row">
            <a type="button" href="<?php echo site_url('admin/process/create'); ?>" class="btn btn-primary">ADD PROCESS</a>
            <?php echo form_submit('submit', 'DELETE ALL SELECTED PROCESS', 'class="btn btn-danger"'); ?>
        </div>
        <div class="row">
            <div class="col-lg-12" style="margin-top: 10px;">
                ...
                if (!empty($Process)) {
                    ...
                    foreach ($Process as $item):
                        ...
                        echo  '<td>' .'<a class="btn btn-primary" href="'.site_url('admin/process/edit/'.$item['id']).'"> Edit </a>'. '</td>';
                        echo '</tr>';
                    endforeach;
                }else {
