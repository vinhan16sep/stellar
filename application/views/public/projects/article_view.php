...
<section class="container">
    ...
    <div class="blog_content col-lg-8 col-md-8 col-sm-8 col-xs-12">
        <h3 class="title"><?php echo $article['article_title']; ?></h3>
            ...
            <div class="related_links col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <ul>
                    <?php foreach ($articles as $key => $item): ?>
                        <?php if ($item['article_id'] != $current_article_id): ?>
                            <li><a href="<?php echo base_url('projects/article/' . $item['article_id']); ?>"><?php echo $item['article_title']; ?></a></li>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </ul>
            </div>
