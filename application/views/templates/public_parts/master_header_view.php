            ...
            <div class="row">
                ...
                <div class="main_nav col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-pills nav-justified">
                        <li class="nav_li <?php echo ($action == 'homepage') ?  'nav_active' : ''; ?>">
                            <a href="<?php echo site_url('homepage'); ?>"><?php echo $this->lang->line('home'); ?></a>
                        </li>
                        <li class="nav_li <?php echo ($action == 'overview') ?  'nav_active' : ''; ?>">
                            <a href="<?php echo site_url('overview'); ?>"><?php echo $this->lang->line('Project_Overview'); ?></a>
                        </li>
                        <li class="nav_li <?php echo ($action == 'location') ? 'nav_active' : ''; ?>">
                        ...
                        <li class="nav_li <?php echo ($action == 'utilities') ?  'nav_active' : ''; ?>">
                            <a href="<?php echo site_url('utilities'); ?>"><?php echo $this->lang->line('Utilities'); ?></a>
                        </li>
                        <li class="nav_li <?php echo ($action == 'progress') ?  'nav_active' : ''; ?>">
                        ...
                        <li class="nav_li <?php echo ($action == 'faq') ?  'nav_active' : ''; ?>">
                            <a href="<?php echo site_url('faq'); ?>"><?php echo $this->lang->line('qa'); ?></a>
                        </li>
                        <li class="nav_li <?php echo ($action == 'download') ?  'nav_active' : ''; ?>">
